      ...
      <main className="flex-1">
        ...
        <div className="container px-8 py-20">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">What Our Students Say</h2>
            <p className="text-lg text-gray-600">
              Hear from our graduates about how e-somo has helped them transform their careers and achieve their goals.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial) => (
              <div
                key={testimonial.id}
                className="bg-white p-8 rounded-xl shadow-sm border border-gray-200 flex flex-col"
              >
